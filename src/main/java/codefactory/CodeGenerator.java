...
public class CodeGenerator {
	...
	public static void genterTable() throws Exception{
				String templatePath = "D:/git-repository/git-CodeGenerator/codeFactory/src/main/resources/template";
...
//				GeneratorControl
				...
				for (Table table : tableList) {
					System.out.println(table.getSqlName()+"  --   "+table.getClassName() +"  注释： "+table.getRemarks());
				}

...
public class DBInfo {
	...
	static {
		...
		DB_URL_MAP.put("mysql", "jdbc:mysql://{ip}:{port}/{database}?useUnicode=true&amp;characterEncoding=UTF-8&amp;useInformationSchema=true");
		DB_URL_MAP
				.put("sqlserver2000",
	...
	public static String getDriverUrl(String dbtype, String ip, String port, String dbname) {
		...
		if (dburl != null) {
			return GeneratorProperties.getProperty("jdbc_url");
		}
		return null;
	}
